...
class Environment
{
     ...
     *
     * @param \VideoBundle\Entity\Environment $environmentParentid
     *
     * @return Environment
     */
    public function setEnvironmentParentid(\VideoBundle\Entity\Environment $environmentParentid = null)
    {
